...
class AdminResourceTableSeeder extends Seeder {
    ...
    public function run()
    {
        Resource::insert([
            ...
            ['id' => 'admin-country-at1',           'name' => 'Countries -- Territorial Areas 1',       'package_id' => 20],
            ['id' => 'admin-country-at2',           'name' => 'Countries -- Territorial Areas 2',       'package_id' => 20],
            ['id' => 'admin-country-at3',           'name' => 'Countries -- Territorial Areas 3',       'package_id' => 20],
            ['id' => 'admin-cron',                  'name' => 'Cron task',                              'package_id' => 20],
            ['id' => 'admin-email-account',         'name' => 'Email accounts',                         'package_id' => 20],
            ['id' => 'admin-google-services',       'name' => 'Google Services',                        'package_id' => 20],
