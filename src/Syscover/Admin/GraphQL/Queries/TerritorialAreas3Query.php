...
class TerritorialAreas3Query extends Query
{
    protected $attributes = [
        'name'          => 'TerritorialAreas3Query',
        'description'   => 'Query to get TerritorialAreas3'
    ];

    public function type()
    {
        return Type::listOf(GraphQL::type('AdminTerritorialArea3'));
    }
