...
class TerritorialAreas2Query extends Query
{
    protected $attributes = [
        'name'          => 'TerritorialAreas2Query',
        'description'   => 'Query to get TerritorialAreas2'
    ];

    public function type()
    {
        return Type::listOf(GraphQL::type('AdminTerritorialArea2'));
    }
