...
class TerritorialAreas1Query extends Query
{
    protected $attributes = [
        'name'          => 'TerritorialAreas1Query',
        'description'   => 'Query to get TerritorialAreas1'
    ];

    public function type()
    {
        return Type::listOf(GraphQL::type('AdminTerritorialArea1'));
    }
